...
class SummarizeUsdaYearCountyTask(luigi.Task):
    ...
    def requires(self):
        """Indicate that the cluster is required.

        Returns:
            cluster_tasks.StartClusterTask
        """
        return cluster_tasks.StartClusterTask()
    ...
    def run(self):
        ...
        future_nested = client.map(process_year, const.YEARS)
