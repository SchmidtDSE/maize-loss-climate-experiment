...
# Introduction
Public institutions such as government-supported crop insurance play an important role in food system health and stability across much of the world [@mahul_government_2010]. We add to existing work regarding global warming impacts to these important food systems actors by examining the U.S. Federal Crop Insurance Program inside the U.S. Corn Belt. More specifically, we build upon prior climate projection and remote sensing yield estimation efforts to generate yield loss projections for maize through Monte Carlo simulations on top of neural network regressors. This work enables simulations of Yield Protection claims as part of Multi-Peril Crop Insurance through predictions at an institutionally-relevant granular spatial scale. This approach understands possible climate impacts on this important institution and may help inform future climate adapation efforts.
