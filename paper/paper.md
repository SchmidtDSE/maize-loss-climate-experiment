...
### Statutory changes
Altogether, while trend adjustment and historically-consistent expected increases in yields outside our model likely negate each other, these model limitations likely overall lead to a supression of loss rates in our simulations. Even so, note that these adjustments change over time and 2014 in particular saw a number of statutory changes [@ers_farm_2014] that could cause this under-estimation to fluctuate across the historic record.
