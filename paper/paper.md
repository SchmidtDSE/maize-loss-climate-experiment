...
## Yield expectations
Figure @fig:hist highlights structural changes to yield deltas we predict due to climate change. This comparison reveals possible challenges with using a simple average in crop insurance products: simulations anticipate that the claims rate increases under climate change (SSP245) to outpace evolving yield means used to set expectations.
