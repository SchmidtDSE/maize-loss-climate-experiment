...
## Claims rate rebound
We begin by further examining a "rebound" in which the claims rate is higher in the 2030 series compared to the 2050 series for our SSP245 simulations.

### Explanation of rebound
To understand this phenomenon, consider that yields generally increase over time [@nielsen_historical_2023]. However, our simulations anticipate more yield gains between 2030 and 2050 ({% if counterfactualMean2050|float > 0 %}+{% endif %}{{counterfactualMean2050}}) compared to historic and 2030 ({% if counterfactualMean2030|float > 0 %}+{% endif %}{{counterfactualMean2030}}) within SSP245. This may reflect that some changes like for temperature within SSP245 [@williams_high_2024] are more extreme from the historic series to 2030 than for 2030 series to 2050. For example, using average daily maximum temperatures, the change from 2030 to 2050 is about one third (37%) lower than the change from historic to 2030. In other words, this "slow down" in worsening growing conditions may allow historically consistent increases in yields to partially compensate.

### Institutional implications of rebound
This "rebound" is consistent across multiple executions of the pipeline and different sets of future years sampled. However, if simulations supress these historically-consistent mean yield improvements, 2050 sees slightly higher claims rates than 2030. This may suggest that, should anticipated continued general agricultural improvements fail to materialize, predicted claims rates would worsen even further than currently predicted. Finally, while our results indicate that the simulated changes in claims rates are large and statistically significant over multi-year periods, this result emphasizes that these changes do not necessarily exhibit year to year monotonacity.
