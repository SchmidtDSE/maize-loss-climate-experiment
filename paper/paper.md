...
# Introduction
Public institutions such as government-supported crop insurance play an important role in agricultural stability across much of the world [@mahul_government_2010]. To inform climate adaptation efforts, we add to existing work regarding global warming impacts to these essential food systems actors [@diffenbaugh_historical_2021] through near and medium-term projection. Specifically, we examine the U.S. Federal Crop Insurance Program inside the U.S. Corn Belt geographic region through a neural network Monte Carlo method which builds upon prior climate projections [@williams_high_2024] and remote sensing yield estimations [@lobell_scalable_2015]. These maize loss projections enable prediction of future insurance indemnity claims rates and severities at an institutionally-relevant spatial scale.
...
## Regression
We next build predictive models for distributions of yield delta.
...
Our interactive tools [@pottinger_data_2024] allow for further examination of error and candidates and our supplemental offers additional performance metrics.
