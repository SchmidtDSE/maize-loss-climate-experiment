...
- With additional data, future modeling could relax our normality assumption though we observe that 88% of neighborhoods see approximate symmetry per @kim_statistical_2013 so that later work would likely not remove a systemic bias in results.
