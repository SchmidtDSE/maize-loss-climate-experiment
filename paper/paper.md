...
## Claims rate rebound
The claims rate is higher in the 2030 series compared to the 2050 series. This is in part due to system wide changes in yield and in part due to changing yield expectations. First, yields generally increase over time [@nielsen_historical_2023] which may be attributed to general agricultural improvements. That said, our simulations anticipate more yield gains2030 and 2050 compared to historic and 2030 within SSP245. Specifically, we anticipate a change in mean yields system wide from 2030 to 2050 of {% if counterfactualMean2050|float > 0 %}+{% endif %}{{counterfactualMean2050}} compared to {% if counterfactualMean2030|float > 0 %}+{% endif %}{{counterfactualMean2030}} between historic and 2030. This "rebound" is consistent across multiple executions of the pipeline. Secondarily, we also acknowledge that yield expectations partially adjust in a minority of areas where $y_{expected}$ decreases from the 2030 series going into the 2050 series. These neighborhoods may experience yield decreases in both 2030 and 2050 relative to historic levels but they only experience the claim in 2030 due to an updated yield average.
