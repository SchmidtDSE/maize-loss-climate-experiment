...
pandoc -o supplemental.pdf --citeproc --number-sections --filter pandoc-tablenos --filter pandoc-fignos --template=default.tex supplemental_filled.md
pandoc -o supplemental.tex --citeproc --number-sections --filter pandoc-tablenos --filter pandoc-fignos --template=default.tex supplemental_filled.md
