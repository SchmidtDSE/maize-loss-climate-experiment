...
class CombineStatsTask(luigi.Task):
    ...
    def run(self):
        ...
        output_record = {
            ...
            'climateMeanMae': posthoc_inputs['climateMeanMae'],
            'climateMeanMdae': posthoc_inputs['climateMeanMdae'],
            'climateStdMae': posthoc_inputs['climateStdMae'],
            'climateStdMdae': posthoc_inputs['climateStdMdae'],
            'climateCount': posthoc_inputs['climateCount'],
            'climatePercent': posthoc_inputs['climatePercent'],
